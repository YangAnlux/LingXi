export default {
  ...
  workorder: {
    ...
    recordToStatus: '变更后状态',
    recordCreator: '操作人',
    noRecord: '暂无处理记录',
    paramError: '参数错误',
    satisfactionScore: '满意度评分',
    satisfactionComment: '满意度评价',
    satisfactionCommentPlaceholder: '请输入评价内容',
    satisfactionTitle: '满意度回访',
    actionSatisfaction: '回访评分',
    satisfactionSuccess: '回访评分成功',
    statisticsTitle: '工单统计报表',
    statisticsByType: '按工单类型',
    statisticsByStatus: '按工单状态',
    statisticsByAssignee: '按处理人',
    statisticsCount: '数量'
  }
}
