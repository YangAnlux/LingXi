...
const fetchAndFill = async () => {
  // 1. 加载统计数据
  const result = await StatisticFunnelApi.getBusinessInversionRateSummaryByDate(props.queryParams)
  const businessSummaryByDate = result.data as CrmStatisticsBusinessInversionRateSummaryByDateRespVO[]
  // 2.1 更新 Echarts 数据
