package com.meession.etm.module.promotion.enums;
...
public interface ErrorCodeConstants {
    ...
    // ========== 营销活动 1-013-021-000 ==========
    ErrorCode CAMPAIGN_NOT_EXISTS = new ErrorCode(1_013_021_000, "营销活动不存在");
    ErrorCode CAMPAIGN_CLOSED_CANNOT_UPDATE = new ErrorCode(1_013_021_001, "已关闭的营销活动不能修改");
    ErrorCode CAMPAIGN_DELETE_FAIL_STATUS_NOT_CLOSED = new ErrorCode(1_013_021_002, "营销活动未关闭，不能删除");
    ErrorCode CAMPAIGN_CLOSE_FAIL_STATUS_CLOSED = new ErrorCode(1_013_021_003, "营销活动已关闭，不能重复关闭");
